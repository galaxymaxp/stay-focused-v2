...
export function buildSectionPrompt(
  ...
  return [
    ...
    sourceExcerpt,
    "Instructions:",
    "- Populate sourceCore.explanation and sourceCore.keyPoints using ONLY the provided source excerpt for this section. sourceCore is extraction-first: prefer the source's own wording over paraphrase.",
    "- For list-only sections, preserve every source item verbatim in sourceCore.keyPoints using the source wording.",
    "- Do not invent descriptions, mechanisms, examples, causes, or explanatory details in sourceCore for bare list items.",
    "- Put explanatory help about what an item means, why it matters, or how it works in enrichment ONLY. Keep bare source items in sourceCore and place descriptions in enrichment rather than dropping either.",
    "- For a heading-only or very short source, keep sourceCore minimal and use the text as-is with no filler.",
    "- PHASE 1: avoid loose connective verbs such as \"involves\" or \"focuses on\" when the source states a point plainly; mirror the source phrasing. Phase 2 will relax this after adding entailment checks.",
    "- SOURCE: \"Domains of IT Security: 1. Network Security 2. Internet Security 3. Endpoint Security ...\"",
    "- CORRECT core.keyPoints: [\"Network Security\",\"Internet Security\",\"Endpoint Security\", ...]",
    "- CORRECT enrichment: [{term:\"Endpoint Security\", note:\"secures end-user devices like computers and phones\"}]",
    "- WRONG core.keyPoints: [\"Endpoint Security: enhances security by securing end-user devices...\"]",
